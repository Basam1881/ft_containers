...
/*   Updated: 2022/09/10 18:47:14 by bnaji            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool  vectorCapacityTest1(bool printAllTests, size_t testnum) {
  ...
  if (ft_v.size() == v.size() && ft_v1.size() == v1.size() && ft_v2.size() == v2.size()) {
...
bool  vectorCapacityTest2(bool printAllTests, size_t testnum) {
  bool test = false;
  std::cout << "\n" << WHITE << testnum << BLUE
    << " : vector<int|char*|std::string>.max_size()           : " << RESET;
  ...
  if (ft_v.max_size() == v.max_size() && ft_v1.max_size() == v1.max_size()
    && ft_v2.max_size() == v2.max_size()) {
    std::cout << GREEN << "OK" << RESET << std::endl; test = true;
  }
  else std::cout << RED << "KO" << RESET << std::endl;
  ...
  if (!test || printAllTests){
    printAll<int>(v, ft_v);
    printVecMaxSize(v.max_size(), ft_v.max_size());
    std::cout << std::endl;
  }
  if (!test || printAllTests){
    printAll<char *>(v1, ft_v1);
    printVecMaxSize(v1.max_size(), ft_v1.max_size());
    std::cout << std::endl;
  }
  if (!test || printAllTests){
    printAll<std::string>(v2, ft_v2);
    printVecMaxSize(v2.max_size(), ft_v2.max_size());
  }
...
bool  vectorCapacityTest3(bool printAllTests, size_t testnum) {
  bool test = false;
  std::cout << "\n" << WHITE << testnum << BLUE
    << " : vector<int|char*|std::string>.capacity()           : " << RESET;
  ...
  if (ft_v.capacity() == v.capacity() && ft_v1.capacity() == v1.capacity()
    && ft_v2.capacity() == v2.capacity()) {
    std::cout << GREEN << "OK" << RESET << std::endl; test = true;
  }
  else std::cout << RED << "KO" << RESET << std::endl;
...
bool  vectorCapacityTest4(bool printAllTests, size_t testnum) {
  ...
  if (ft_v.empty() == v.empty() && ft_v1.empty() == v1.empty()
    && ft_v2.empty() == v2.empty()) {
    std::cout << GREEN << "OK" << RESET << std::endl; test = true;
  }
  else std::cout << RED << "KO" << RESET << std::endl;
  
  if (!test || printAllTests){
    printAll<int>(v, ft_v); printVecEmpty(v.empty(), ft_v.empty()); std::cout << std::endl;
  }
  if (!test || printAllTests){
    printAll<int>(v1, ft_v1); printVecEmpty(v1.empty(), ft_v1.empty()); std::cout << std::endl;
  }
  if (!test || printAllTests){
    printAll<int>(v2, ft_v2); printVecEmpty(v2.empty(), ft_v2.empty());
  }
