...
/*   Updated: 2022/09/10 18:49:20 by bnaji            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool vectorElementAccessTest2(std::vector<int> const & v,
  ...
  bool test = false;
  std::cout << "\n" << WHITE << testnum << BLUE
    << " : vector<int>.const_operator[]                       : " << RESET;
