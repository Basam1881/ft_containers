...
/*   Updated: 2022/09/10 18:53:27 by bnaji            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool  vectorReverseIteratorsTest3(std::vector<int> & v,
  ...
  bool test = false;
  std::cout << "\n" << WHITE << testnum << BLUE
    << " : vector<int>::reverse_iterator(iterator)            : " << RESET;
...
bool  vectorReverseIteratorsTest4(std::vector<int> & v,
  ...
  bool test = false;
  std::cout << "\n" << WHITE << testnum << BLUE
    << " : vector<int>::reverse_iterator.operator=()          : " << RESET;
...
bool  vectorReverseIteratorsTest10(std::vector<int> & v,
  ...
  bool test = false;
  std::cout << "\n" << WHITE << testnum << BLUE
    << " : vector<int>::reverse_iterator.operator++(int)     : " << RESET;
  ft::vector<int>::reverse_iterator ft_it = ft_v.rbegin();
  ft_it++;
  std::vector<int>::reverse_iterator it = v.rbegin();
  it++;
...
bool  vectorReverseIteratorsTest14(std::vector<int> & v,
  ...
  bool test = false;
  std::cout << "\n" << WHITE << testnum << BLUE
    << " : reverse_iterator = ptrdiff_t + reverse_iterator   : " << RESET;
  ft::vector<int>::reverse_iterator ft_it = ft_v.rbegin();
  ft_it = testnum + ft_it;
  std::vector<int>::reverse_iterator it = v.rbegin();
  it = testnum + it;
...
bool  vectorReverseIteratorsTest15(std::vector<int> & v,
  ...
  bool test = false;
  std::cout << "\n" << WHITE << testnum << BLUE
    << " : ptrdiff_t = reverse_iterator - reverse_iterator   : " << RESET;
  size_t mt;
